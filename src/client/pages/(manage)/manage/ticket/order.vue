<template>
  <UiContent title="Đơn Dịch Vụ" sub="Quản lý danh sách các đơn gọi dịch vụ">
...
const getList = async () => {
  try {
    ...
    const data = await useAPI('ticket/manage/order', JSON.parse(JSON.stringify(page.value)))
