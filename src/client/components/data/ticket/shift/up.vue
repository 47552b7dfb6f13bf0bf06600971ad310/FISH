<template>
  <div v-if="!!ticket">
    ...
    <div v-else>
      <div v-if="!!connect">
        <DataTicketShiftPay :connect="connect" :ticket="ticket" @cancel="emits('close')" />
      </div>
...
const onAction = async () => {
  try {
    ...
    await useAPI('ticket/public/shift/up/create', { 
...
const get = async () => {
  try {
    ...
    const data = await useAPI('ticket/public/shift/up/get', { 
      ticket: props.ticket.code
    })
